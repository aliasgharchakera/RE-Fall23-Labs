...
\begin{figure}[!ht]
	\centering
	\subfloat[frequency = 100Hz]{\includegraphics[width=0.4\columnwidth]{images/part1-graph.jpg}}
	\qquad
	\subfloat[frequency = 1kHz]{\includegraphics[width=0.4\columnwidth]{images/part1-temp1-graph.jpg}}
	\qquad
	\subfloat[frequency = 10kHz]{\includegraphics[width=0.4\columnwidth]{images/part1-temp1-stats.jpg}}
